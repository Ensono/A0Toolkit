...
Describe "Get-A0Client" {
    ...
    Context "Parameter validation fails" {        
        ...
        It "should validate malformed URL and throw" {
            ...
            {Get-A0Client -baseURL $malformedURL } | Should Throw
    ...
    Context "Call Auth0" {
        ...
        It "should Invoke-WebRequest and return response" {
            ...
            Get-A0Client -baseURL $formedURL | Should not be $null
    ...
    Context "Call Auth0 and fail" {
        ...
        It "should throw exception" {
            ...
            {Get-A0Client -baseURL $formedURL} | Should Throw
