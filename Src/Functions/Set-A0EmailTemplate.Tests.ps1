...
Describe "Set-A0EmailTemplate" {
    ...
    Context "Parameter validation fails" {        
        ...
        It "should validate malformed URL and throw" {
            ...
            {Set-A0EmailTemplate -baseURL $malformedURL -templateName $testTemplateName -payload $testPayload } | Should Throw
        ...
        It "should validate templateName missing and throw" {
            ...
            {Set-A0EmailTemplate -baseURL $formedURL -templateName -payload $testPayload } | Should Throw
        ...
        It "should validate payload missing and throw" {
            ...
            {Set-A0EmailTemplate -baseURL $formedURL -templateName $testTemplateName -payload } | Should Throw
    ...
    Context "Call Auth0" {
        ...
        It "should Invoke-WebRequest and return response" {
            ...
            Set-A0EmailTemplate -baseURL $formedURL -templateName $testTemplateName -payload $testPayload | Should not be $null
    ...
    Context "Call Auth0 and fail" {
        ...
        It "should throw exception" {
            ...
            {Set-A0EmailTemplate -baseURL $formedURL -templateName $testTemplateName -payload $testPayload } | Should Throw
