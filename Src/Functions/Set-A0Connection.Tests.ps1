...
Describe "Set-A0Connection" {
    ...
    Context "Parameter validation fails" {        
        ...
        It "should validate malformed URL and throw" {
            ...
            {Set-A0Connection -baseURL $malformedURL -connectionId $testConnectionId -payload $testPayload } | Should Throw
        ...
        It "should validate connectionId missing and throw" {
            ...
            {Set-A0Connection -baseURL $formedURL -connectionId -payload $testPayload } | Should Throw
        ...
        It "should validate payload missing and throw" {
            ...
            {Set-A0Connection -baseURL $formedURL -connectionId $testConnectionId -payload } | Should Throw
    ...
    Context "Call Auth0" {
        ...
        It "should Invoke-WebRequest and return response" {
            ...
            Set-A0Connection -baseURL $formedURL -connectionId $testConnectionId -payload $testPayload | Should not be $null
    ...
    Context "Call Auth0 and fail" {
        ...
        It "should throw exception" {
            ...
            {Set-A0Connection -baseURL $formedURL -connectionId $testConnectionId -payload $testPayload} | Should Throw
