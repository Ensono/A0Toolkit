...
Describe "Remove-A0RuleConfig" {
    ...
    Context "Parameter validation fails" {        
        ...
        It "should validate malformed URL and throw" {
            ...
            {Remove-A0RuleConfig -baseURL $malformedURL -key $testKey} | Should Throw
        ...
        It "should validate key missing and throw" {
            ...
            {Remove-A0RuleConfig -baseURL $formedURL -key} | Should Throw
    ...
    Context "Call Auth0" {
        ...
        It "should Invoke-WebRequest and return response" {
            ...
            Remove-A0RuleConfig -baseURL $formedURL -key $testKey | Should not be $null
    ...
    Context "Call Auth0 and fail" {
        ...
        It "should throw exception" {
            ...
            {Remove-A0RuleConfig -baseURL $formedURL -key $testKey} | Should Throw
