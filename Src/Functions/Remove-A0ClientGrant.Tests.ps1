...
Describe "Remove-A0ClientGrant" {
    ...
    Context "Parameter validation fails" {        
        ...
        It "should validate malformed URL and throw" {
            ...
            {Remove-A0ClientGrant -baseURL $malformedURL -grantId $testgrantId} | Should Throw
        ...
        It "should validate grantId missing and throw" {
            ...
            {Remove-A0ClientGrant -baseURL $formedURL -grantId} | Should Throw
    ...
    Context "Call Auth0" {
        ...
        It "should Invoke-WebRequest and return response" {
            ...
            Remove-A0ClientGrant -baseURL $formedURL -grantId $testgrantId | Should not be $null
    ...
    Context "Call Auth0 and fail" {
        ...
        It "should throw exception" {
            ...
            {Remove-A0ClientGrant -baseURL $formedURL -grantId $testgrantId} | Should Throw
