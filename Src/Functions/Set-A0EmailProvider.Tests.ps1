...
Describe "Set-A0EmailProvider" {
    ...
    Context "Parameter validation fails" {        
        ...
        It "should validate malformed URL and throw" {
            ...
            {Set-A0EmailProvider -baseURL $malformedURL -payload $testPayload } | Should Throw
        ...
        It "should validate payload missing and throw" {
            ...
            {Set-A0EmailProvider -baseURL $formedURL -payload } | Should Throw
    ...
    Context "Call Auth0" {
        ...
        It "should Invoke-WebRequest and return response" {
            ...
            Set-A0EmailProvider -baseURL $formedURL -payload $testPayload | Should not be $null
    ...
    Context "Call Auth0 and fail" {
        ...
        It "should throw exception" {
            ...
            {Set-A0EmailProvider -baseURL $formedURL -payload $testPayload} | Should Throw
