...
Describe "New-A0EmailProvider" {
    ...
    Context "Parameter validation fails" {        
        ...
        It "should validate malformed URL and throw" {
            ...
            {New-A0EmailProvider -baseURL $malformedURL -payload $testPayload } | Should Throw
        ...
        It "should validate payload missing and throw" {
            ...
            {New-A0EmailProvider -baseURL $formedURL -payload } | Should Throw
    ...
    Context "Call Auth0" {
        ...
        It "should Invoke-WebRequest and return response" {
            ...
            New-A0EmailProvider -baseURL $formedURL -payload $testPayload | Should not be $null
    ...
    Context "Call Auth0 and fail" {
        ...
        It "should throw exception" {
            ...
            {New-A0EmailProvider -baseURL $formedURL -payload $testPayload} | Should Throw
