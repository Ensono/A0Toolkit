...
Describe "New-A0Connection" {
    ...
    Context "Parameter validation fails" {        
        ...
        It "should validate malformed URL and throw" {
            ...
            {New-A0Connection -baseURL $malformedURL -payload $testPayload } | Should Throw
        ...
        It "should validate payload missing and throw" {
            ...
            {New-A0Connection -baseURL $formedURL -payload } | Should Throw
    ...
    Context "Call Auth0" {
        ...
        It "should Invoke-WebRequest and return response" {
            ...
            New-A0Connection -baseURL $formedURL -payload $testPayload | Should not be $null
    ...
    Context "Call Auth0 and fail" {
        ...
        It "should throw exception" {
            ...
            {New-A0Connection -baseURL $formedURL -payload $testPayload} | Should Throw
