...
Describe "Get-A0Connection" {
    ...
    Context "Parameter validation fails" {        
        ...
        It "should validate malformed URL and throw" {
            ...
            {Get-A0Connection -baseURL $malformedURL } | Should Throw
    ...
    Context "Call Auth0" {
        ...
        It "should Invoke-WebRequest and return response" {
            ...
            Get-A0Connection -baseURL $formedURL | Should not be $null
    ...
    Context "Call Auth0 and fail" {
        ...
        Mock -CommandName Invoke-WebRequest -Verifiable -MockWith {
            ...
            Throw $testExceptionMessage
        }

        It "should throw exception" {

            {Get-A0Connection -baseURL $formedURL} | Should Throw
