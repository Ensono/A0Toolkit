...
Describe "Get-A0RuleConfig" {
    ...
    Context "Parameter validation fails" {        
        ...
        It "should validate malformed URL and throw" {
            ...
            {Get-A0RuleConfig -baseURL $malformedURL } | Should Throw
    ...
    Context "Call Auth0" {
        ...
        It "should Invoke-WebRequest and return response" {
            ...
            Get-A0RuleConfig -baseURL $formedURL | Should not be $null
    ...
    Context "Call Auth0 and fail" {
        ...
        It "should throw exception" {
            ...
            {Get-A0RuleConfig -baseURL $formedURL} | Should Throw
